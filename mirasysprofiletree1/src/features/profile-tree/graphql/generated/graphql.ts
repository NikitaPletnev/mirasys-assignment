...
export enum AudioAlarmTriggerOperation {
  High = 'HIGH',
  Low = 'LOW'
}
...
export enum DigitalSourcePolarity {
  Closed = 'CLOSED',
  Opened = 'OPENED'
}
...
export enum DigitalSourceState {
  Closed = 'CLOSED',
  Open = 'OPEN',
  Unknown = 'UNKNOWN'
}
...
export enum DisableClientZonesAlarmType {
  Blurring = 'BLURRING',
...
export enum EmailAlarmActionImageSizeLimit {
...
export enum ExternalAlarmTriggerType {
  Channel = 'CHANNEL',
  Generic = 'GENERIC'
}
...
export enum MetadataAlarmTriggerSourceType {
  Any = 'ANY',
  Audio = 'AUDIO',
  Io = 'IO',
  Textdata = 'TEXTDATA',
...
export enum PrimaryAction {
  ...
  DomeControl = 'DOME_CONTROL',
  MakeArchive = 'MAKE_ARCHIVE',
  NoAction = 'NO_ACTION',
  OpenAlarmPlayback = 'OPEN_ALARM_PLAYBACK',
  OpenPlayback = 'OPEN_PLAYBACK',
  OpenRealtime = 'OPEN_REALTIME',
  PulseState = 'PULSE_STATE',
  RefreshState = 'REFRESH_STATE',
  ShowActions = 'SHOW_ACTIONS',
  ShowAlarmViews = 'SHOW_ALARM_VIEWS',
  ShowCapture = 'SHOW_CAPTURE',
  ShowDescription = 'SHOW_DESCRIPTION',
  ShowDome = 'SHOW_DOME',
  ShowInfo = 'SHOW_INFO',
  ShowReferenceImage = 'SHOW_REFERENCE_IMAGE',
...
export enum PtzAlarmActionType {
  Preset = 'PRESET',
  Program = 'PROGRAM'
}
...
export enum TextAlarmTriggerOperation {
...
export enum Transport {
  Automatic = 'AUTOMATIC',
  RtPoverHttp = 'RT_POVER_HTTP',
  RtPoverHttps = 'RT_POVER_HTTPS',
  RtPoverMulticast = 'RT_POVER_MULTICAST',
  RtPoverRtsp = 'RT_POVER_RTSP',
  RtPoverUdp = 'RT_POVER_UDP'
}
...
export enum VideoAlarmTriggerOperation {
  Motion = 'MOTION',
  NoMotion = 'NO_MOTION',
  NoSignal = 'NO_SIGNAL'
}
...
type NodeBase_AlarmNode_Fragment = { __typename?: 'AlarmNode', id: string, name: string, kind: string, parentNodeId?: string | null } & { ' $fragmentName'?: 'NodeBase_AlarmNode_Fragment' };

type NodeBase_DigitalInputNode_Fragment = { __typename?: 'DigitalInputNode', id: string, name: string, kind: string, parentNodeId?: string | null } & { ' $fragmentName'?: 'NodeBase_DigitalInputNode_Fragment' };

type NodeBase_DigitalOutputNode_Fragment = { __typename?: 'DigitalOutputNode', id: string, name: string, kind: string, parentNodeId?: string | null } & { ' $fragmentName'?: 'NodeBase_DigitalOutputNode_Fragment' };

type NodeBase_FolderNode_Fragment = { __typename?: 'FolderNode', id: string, name: string, kind: string, parentNodeId?: string | null } & { ' $fragmentName'?: 'NodeBase_FolderNode_Fragment' };

type NodeBase_VideoChannelNode_Fragment = { __typename?: 'VideoChannelNode', id: string, name: string, kind: string, parentNodeId?: string | null } & { ' $fragmentName'?: 'NodeBase_VideoChannelNode_Fragment' };

export type NodeBaseFragment =
  | NodeBase_AlarmNode_Fragment
  | NodeBase_DigitalInputNode_Fragment
  | NodeBase_DigitalOutputNode_Fragment
  | NodeBase_FolderNode_Fragment
  | NodeBase_VideoChannelNode_Fragment
;

export type ListProfileNodesQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']['input']>;
  after?: InputMaybe<Scalars['String']['input']>;
  where?: InputMaybe<ProfileNodeFilterInput>;
  order?: InputMaybe<Array<ProfileNodeSortInput> | ProfileNodeSortInput>;
}>;


export type ListProfileNodesQuery = { __typename?: 'Query', listProfileNodes?: { __typename?: 'ListProfileNodesConnection', nodes?: Array<
      | { __typename?: 'AlarmNode', id: string, name: string, kind: string, parentNodeId?: string | null }
      | { __typename?: 'DigitalInputNode', id: string, name: string, kind: string, parentNodeId?: string | null }
      | { __typename?: 'DigitalOutputNode', id: string, name: string, kind: string, parentNodeId?: string | null }
      | { __typename?: 'FolderNode', id: string, name: string, kind: string, parentNodeId?: string | null }
      | { __typename?: 'VideoChannelNode', id: string, name: string, kind: string, parentNodeId?: string | null }
    > | null, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, endCursor?: string | null } } | null };

export const NodeBaseFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"NodeBase"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"IProfileNode"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"parentNodeId"}}]}}]} as unknown as DocumentNode<NodeBaseFragment, unknown>;
export const ListProfileNodesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ListProfileNodes"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"after"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"where"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ProfileNodeFilterInput"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"order"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ProfileNodeSortInput"}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"listProfileNodes"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}},{"kind":"Argument","name":{"kind":"Name","value":"after"},"value":{"kind":"Variable","name":{"kind":"Name","value":"after"}}},{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"Variable","name":{"kind":"Name","value":"where"}}},{"kind":"Argument","name":{"kind":"Name","value":"order"},"value":{"kind":"Variable","name":{"kind":"Name","value":"order"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"parentNodeId"}}]}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}},{"kind":"Field","name":{"kind":"Name","value":"endCursor"}}]}}]}}]}}]} as unknown as DocumentNode<ListProfileNodesQuery, ListProfileNodesQueryVariables>;
/** All built-in and custom scalars, mapped to their actual values */
export type Scalars = {
  ID: { input: string; output: string; }
  String: { input: string; output: string; }
...
export const NodeBaseFragmentDoc = gql`
    fragment NodeBase on IProfileNode {
  id
  name
  kind
  parentNodeId
    ...
    `;
export const ListProfileNodesDocument = gql`
...
/**
 * __useListProfileNodesQuery__
 *
 * To run a query within a React component, call `useListProfileNodesQuery` and pass it any options that fit your needs.
 * When your component renders, `useListProfileNodesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useListProfileNodesQuery({
 *   variables: {
 ...
 * });
 */
export function useListProfileNodesQuery(baseOptions?: Apollo.QueryHookOptions<ListProfileNodesQuery, ListProfileNodesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ListProfileNodesQuery, ListProfileNodesQueryVariables>(ListProfileNodesDocument, options);
      }
export function useListProfileNodesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListProfileNodesQuery, ListProfileNodesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ListProfileNodesQuery, ListProfileNodesQueryVariables>(ListProfileNodesDocument, options);
        }
export function useListProfileNodesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<ListProfileNodesQuery, ListProfileNodesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ListProfileNodesQuery, ListProfileNodesQueryVariables>(ListProfileNodesDocument, options);
        }
export type ListProfileNodesQueryHookResult = ReturnType<typeof useListProfileNodesQuery>;
export type ListProfileNodesLazyQueryHookResult = ReturnType<typeof useListProfileNodesLazyQuery>;
export type ListProfileNodesSuspenseQueryHookResult = ReturnType<typeof useListProfileNodesSuspenseQuery>;
export type ListProfileNodesQueryResult = Apollo.QueryResult<ListProfileNodesQuery, ListProfileNodesQueryVariables>;